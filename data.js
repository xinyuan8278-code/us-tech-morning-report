...
window.REPORT_DATA = {
  ...
  meta: {
    ...
    reportDate: "2026年09月05日",   // 报告发布日期
    tradeDate: "2026年09月04日",    // 对应美股交易日（前一交易日）
    author: "华泰期货 · 研究",
    tag: "每日市场跟踪"
  },
  ...
  overview: {
    /* 简短概括：指数变化 + 个股变化 + 重大事件 */
    text: "9月4日美股三大指数小幅收跌：道指-0.51%、标普-0.38%、纳指-0.29%，但费城半导体指数逆势大涨3.37%。8月非农新增16.2万远超预期，9月加息概率升至约58%，美债收益率上行，大型科技股普跌（苹果-2.51%、微软-2.04%）。存储与半导体逆势爆发：闪迪+11.90%、美光+6.10%、AMD+4.69%。",
    /* 指数卡片（可增删） */
    indices: [
  ...
  stocks: [
    { name: "NVIDIA",    code: "NVDA",  change: "-0.00%", driver: "英伟达收购Hugging Face情绪延续，AI算力主线获资金回流，逆势涨0.84%、股价逼近历史高位" },
    { name: "Microsoft", code: "MSFT",  change: "-0.00%", driver: "强非农推高加息预期、美债收益率上行，大型软件股承压，跌2.04%" },
    { name: "Apple",     code: "AAPL",  change: "-0.00%", driver: "大型科技股集体回调、消费电子走弱，跌2.51%，为当日跌幅居前权重股" },
    { name: "Amazon",    code: "AMZN",  change: "-0.00%", driver: "大盘走弱、消费科技股承压，微跌0.15%" },
    { name: "Alphabet",  code: "GOOGL", change: "-0.00%", driver: "软件/平台股随大盘回落，跌1.17%" },
  ...
  news: [
    {
      ...
      summary: "8月非农新增16.2万个岗位，远超市场预期的约5.6万，为3月以来最高；失业率持平于4.1%。6月、7月数据合计上修5.5万（7月由-2.3万修正为+2.1万）。就业增长以餐饮（+5.9万）与地方政府教育（+4.2万）为主，信息业减少2.3万。平均时薪同比+3.1%、环比+0.3%，仍低于整体通胀。数据印证劳动力市场韧性，为美联储9月加息提供支撑。",
      impact: {
        direction: "中性",
    ...
    {
      title: "强非农推升美债收益率与9月加息押注至约59%，美股大盘承压",
      ...
      summary: "8月非农公布后，短期利率期货隐含9月加息概率由约55%升至约59%。2年期美债收益率升5bp至4.38%，10年期升1bp至4.776%；美元指数升至99.12，黄金跌1.2%至4418美元。策略师普遍认为非农并未改变基本面，最终仍将取决于下周CPI；工资同比3.1%为2021年6月来最低，为鸽派留有余地。",
      impact: {
        direction: "利空",
        companies: "全市场、大型科技",
        industry: "利率、美元、债券",
    ...
    },
    {
      ...
      summary: "存储板块周五普涨：美光、SK海力士、闪迪盘前分别涨约2%、2%、3%。戴尔最新财报显示AI服务器积压订单达950亿美元，COO Jeffrey Clarke称最大瓶颈仍是'DRAM、DRAM、DRAM，其次NAND、NAND、NAND'。Susquehanna预计本季度DRAM合约价环比涨超50%、NAND涨约60%；Q2 DRAM营收+57%、NAND营收+70%。",
      impact: {
        direction: "利好",
    ...
    {
      title: "NHTSA对约1000辆特斯拉Cybercab展开安全合规调查，特斯拉跌近6%领跌大型科技股",
      originalTitle: "US opens probe into Tesla Cybercab compliance with federal safety rules",
      source: "路透社（Reuters，经 The Star 转载）",
      time: "2026年09月04日",
      type: "财经媒体",
      url: "https://www.thestar.com.my/tech/tech-news/2026/09/04/us-opens-probe-into-tesla-cybercab-compliance-with-federal-safety-rules",
      link: "https://www.thestar.com.my/tech/tech-news/2026/09/04/us-opens-probe-into-tesla-cybercab-compliance-with-federal-safety-rules",
      summary: "美国国家公路交通安全管理局（NHTSA）周五对约1000辆特斯拉Cybercab展开调查，审查特斯拉申报联邦机动车安全标准合规所依据的流程与技术数据。Cybercab缺少方向盘、刹车踏板、油门及后视镜等常规手动控制装置。此前特斯拉于9月3日在奥斯汀启动少量Cybercab商业部署。特斯拉当日收跌5.92%，为科技巨头中跌幅最大。",
      impact: {
        direction: "利空",
        companies: "特斯拉、自动驾驶产业链",
        industry: "自动驾驶、监管",
        logic: "Cybercab合规认证受审，或影响特斯拉Robotaxi扩张节奏；事件体现科技股在高利率环境下的监管与估值双重压力"
      }
    }
  ],
  ...
  logics: [
    { title: "强就业推升加息预期，利率与流动性重新成为核心压制变量",
      text: "8月非农新增16.2万远超预期、6/7月数据上修，9月加息概率由约55%升至约58-60%，2年期美债收益率升5bp、10年期站上4.78%，美元走强、黄金跌1.2%。市场情绪从上一日'沃勒偏鸽'的risk-on迅速转向'强就业=加息'的risk-off，大型软件与消费科技股普跌。这一逻辑的持续性取决于下周CPI能否确认通胀降温。" },
    { title: "AI硬件与存储成为'加息环境避风港'：资金从软件向算力/存储硬件轮动",
      text: "三大指数集体收跌之际，费城半导体指数逆势大涨3.37%，闪迪+11.90%、美光+6.10%、AMD+4.69%。市场当日同时进行两笔交易——大盘交易'加息'、AI硬件交易'产业逻辑'（数据中心资本开支延续+存储涨价）。软件ETF跌超2%，硬件强、软件弱的板块内部分化显著，资金持续向算力与存储基础设施集中。" },
    { title: "存储超级周期进入'供给响应'阶段：NAND/DRAM涨价驱动盈利与估值双重重估",
      text: "戴尔'DRAM、DRAM、DRAM'印证AI服务器存储短缺，Susquehanna预计本季DRAM合约价QoQ+50%、NAND+60%；美光HBM月产能年底翻倍至10万片、闪迪毛利率突破80%。存储股正从'强周期股'向'AI基础设施核心资产'重估，美光首破1000美元、闪迪市值破2500亿美元。需警惕涨价见顶与估值透支的双重风险。" }
  ],

  /* ============ 七、未来 1—3 个交易日关注事项（具体事件） ============ */
  watchlist: [
    { date: "09月07日", event: "美国劳动节（Labor Day），美股休市", impact: "长假前资金趋于谨慎，短期波动或收敛" },
    { date: "09月09日", event: "苹果秋季发布会，预计发布iPhone 18及首款折叠屏iPhone", impact: "检验苹果AI与折叠屏创新能否对冲9/4股价-2.51%的回调压力" },
    { date: "09月10-11日", event: "美国8月CPI与PPI通胀数据", impact: "9月FOMC决策的核心依据，通胀走向直接决定加息与否，当前加息押注约58%" },
    { date: "09月15-16日", event: "美联储FOMC议息会议", impact: "市场定价9月加息25bp概率约58-60%，影响高估值成长股估值锚" },
